...
def _print_pipeline_summary(
    *,
    ...
    summary_lines = [
        ...
        f"Landlord/violator features available: {landlord_available}",
...
def main() -> None:
    ...
    model_path = run_baseline_model(BaselineModelConfig(input_path=feature_path))
